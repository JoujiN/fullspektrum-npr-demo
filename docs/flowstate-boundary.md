...
FlowState is the generic runtime. FullSpektrum NPR onboarding is a downstream application of that runtime.
...
Only upstream these kinds of changes to FlowState:

- Generic runtime bugs.
- Generic swarm/agent loading improvements.
- Generic config or auth fixes.
